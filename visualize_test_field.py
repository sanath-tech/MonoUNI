...
#####input
dataset_dir = '/home/workstation/Documents/MonoUNI/test_field_data'
instance = 'mast_22_left'
...
for i in range(0,197):
       file_number = f'{i:06}'
       image = cv2.imread(f"/home/workstation/Documents/output_images/frame_{file_number}.jpg")
       resolution = [960 ,512]
       ...
       img = show_box_with_roll(image,detection_file,extrinsic_file,denorm_file,calfile,dets,network=True,thresh=0.5, projectMethod='Ground')
       cv2.imwrite(f"/home/workstation/Documents/MonoUNI/result/{file_number}.jpg", img)
...
featue_size = [960/4, 512/4]

bbox_ds = [1920,1200]img_size/[240,128]features_size
8,9.375 """